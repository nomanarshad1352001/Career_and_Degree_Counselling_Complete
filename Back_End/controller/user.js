...
export const signin = async (req, res) => {
    ...
    try {
        ...
        const token = jwt.sign({email: existingUser.email, id: existingUser._id}, 'gcsit' , { expiresIn: "1h" });
...
export const signup = async (req, res) => {
    ...
    try {
        ...
        if (existingUser)return res.status(400).json({ message: "User alrady exists"});
